...
MyGame = ig.Box2DGame.extend({
	...
	spawnInNewItem: function(){
		...
		if( randNum <= 0.20 ){
			...
			switch( number ){
				case 1: 
					ig.game.spawnEntity( EntityCatProjectile , 86 , 640 , { newest: true, } );
				break;
				case 2: 
					ig.game.spawnEntity( EntityBuddhaProjectile , 86 , 640 , { newest: true, } );
				break;
			}

		}
		else if( randNum >= 0.85 ){
			ig.game.spawnEntity( EntityObstacle , 86 , 640 , { newest: true, } );
		}
