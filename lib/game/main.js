...
MyGame = ig.Box2DGame.extend({
	...
	sortZindex: function(){
		...
		for( var i = 0 ; i < this.itemsArray.length ; i++ ){
			...
			if( this.itemsArray[i].name == "PLAYBUTTON"){
				this.itemsArray[i].zIndex = i + 20;
			}
			else { this.itemsArray[i].zIndex = i + 10; }
		}
	...
	spawnInNewItem: function(){
		...
		ig.game.spawnEntity( EntityItem_dispenser , 86 , 1000 , { newest: true, } );
