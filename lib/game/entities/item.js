...
EntityItem = ig.Box2DEntity.extend({
	...
	createBody: function() {
		...
		jointDef.bodyA = ig.game.getEntitiesByType(EntityBalloon_ropeSegment)[ i + this.multiplier ].body;
	    jointDef.bodyB = ig.game.getEntitiesByType(EntityBalloon_anchor)[0].body;
	    jointDef.length = 0.1;
